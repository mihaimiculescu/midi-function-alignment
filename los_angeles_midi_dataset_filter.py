...
os.chdir('/home/theea/Los-Angeles-MIDI-Dataset/content/Los-Angeles-MIDI-Dataset')
import MIDI
...
os.chdir('/home/theea/Los-Angeles-MIDI-Dataset/content/')
print('Done!')
...
meta_data = pickle.load(open('/home/theea/Los-Angeles-MIDI-Dataset/META-DATA/LAMDa_META_DATA.pickle', 'rb'))
print('Done!')
print('=' * 70)
print('Loading LAMDa TOTALS...')
totals = pickle.load(open('/home/theea/Los-Angeles-MIDI-Dataset/TOTALS/LAMDa_TOTALS.pickle', 'rb'))
print('Done!')
print('=' * 70)
print('Enjoy!')
print('=' * 70)
...
dataset_addr = "/home/theea/midi-function-alignment/Dataset/Los-Angeles-MIDI-Dataset-Ver-4-0-CC-BY-NC-SA/MIDIs"
...
full_path_to_source_MIDI = "/home/theea/Los-Angeles-MIDI-Dataset/content/Los-Angeles-MIDI-Dataset/Come-To-My-Window-Modified-Sample-MIDI.mid" #@param {type:"string"}
